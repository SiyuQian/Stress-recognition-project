...
def report_index(request):
    ...
    if records:
        ...
        for row in rows:
            ...
            if rows[current_row_number]['status_basic'] == 'warning' or rows[current_row_number]['status_basic'] == 'basic_warning':
                detected_stress_x_basic.append(rows[current_row_number]['minute'])
            ...
            if rows[current_row_number]['status_sliding'] == 'sliding_warning':
                detected_stress_x_sliding.append(rows[current_row_number]['minute'])
    ...
    x_axis_labels = df['minute'].tolist()[x_axis_start:x_axis_end]
